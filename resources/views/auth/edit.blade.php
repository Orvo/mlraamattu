	...
	{!! Form::open(['method' => 'POST', 'action' => 'AuthController@save', 'class' => 'form-horizontal']) !!}
		...
		<fieldset>
			...
			<div class="form-group">
				<label for="user-name" class="control-label col-sm-3">
					Käyttäjän nimi
				</label>
				<div class="col-sm-9">
			...
			<div class="form-group">
				<label for="user-email" class="control-label col-sm-3">
		...
		<fieldset>
			...
			@if(Auth::user()->change_password)
				<div class="form-group">
					<div class="col-sm-offset-3 alert alert-danger alert-icon alert-icon-small login-note">
			...
			@endif
			<div class="form-group">
				<label for="user-current-password" class="control-label col-sm-3">
					Nykyinen salasana
				</label>
				<div class="col-sm-9">
			...
			<div class="form-group">
				<label for="user-new-password" class="control-label col-sm-3">
					Uusi salasana
				</label>
				<div class="col-sm-9">
			...
			<div class="form-group">
				<label for="user-password_confirmation" class="control-label col-sm-3">
